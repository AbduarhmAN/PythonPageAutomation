...
class DataManager:
    ...
    groups_button: str = (
        "//*[local-name()='img' and contains(@src,'https://static.xx.fbcdn.net/rsrc.php/v4/yZ/r/MhkwI3R0SHP.png') and @class='x1b0d499 xl1xv1r']"
    )
    menu_button: str = (
    ...
    all_profiles_button: str = (
        "//*[local-name()='span' and contains(@class,'x193iq5w xeuugli x13faqbe x1vvkbs x1xmvt09 x1lliihq x1s928wv xhkezso x1gmr53x x1cpjm7i x1fgarty x1943h6x xudqn12 x3x7a5m x6prxxf xvq8zen x1s688f x1dem4cn')]//*[local-name()='span' and @class='x1lliihq x6ikm8r x10wlt62 x1n2onr6 xlyipyv xuxw1ft']"
    )
...
class ConfigManager:
    def __init__(
        ...
        main_page: str = "",
        current_account: str = "",
        pages_on_account: WebElement = None,
    ):
        """
        ...
        self.PagesOnAccount: WebElement = (
            pages_on_account  # Assigned via external parameter
        )
    ...
    def getAccountPages(
        self, cAccount: str = "", unorgnizedElements: WebElement = None
    ) -> List[WebElement]:
        """
        ...
        try:
            ...
            print(
                f"Pages on the account are: {[page.text for page in organizedElements]}"
            )
    ...
    def _filter_pages(
        self, pages: List[WebElement], cAccount: str, skip_last: bool
    ) -> List[WebElement]:
        """
