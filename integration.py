...
class SeleniumManager :
    ...
    def Initialze_webdriver(self):
        ...
        chrome_options.add_argument("user-data-dir=C:/Users/OBT/AppData/Local/Google/Chrome/User Data")
    ...
    def navigate_to_elem(self, element,min_coordinate = 10,movement_duration = 1):
        ...
        browser_offset_y = self.__wdriver.execute_script("return window.outerHeight - window.innerHeight;")
        browser_offset_x = self.__wdriver.execute_script("return window.outerWidth - window.innerWidth;")

        rect = self.__wdriver.execute_script("return arguments[0].getBoundingClientRect();", element)
